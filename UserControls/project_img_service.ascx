<%@ Control Language="C#" AutoEventWireup="true" CodeFile="project_img_service.ascx.cs"
    Inherits="UserControls_project_img_service" %>
...
<table dir="rtl" style="line-height: 2; width: 99%;">
    ...
    <tr>
        <td align="center" colspan="4" style="height: 33px">
            <asp:Label ID="Label2" runat="server" CssClass="PageTitle" Text="ملفات صور خدمات المشروع" />
        </td>
    </tr>
    <tr>
            ...
            <asp:GridView ID="GrdView_Documents" runat="server" AutoGenerateColumns="False" CellPadding="3"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="الوثيقة">
                        <ItemTemplate>
                            <a href='<%# "ALL_Document_Details.aspx?type=imgservice&id="+ Eval("proj_img_service_id") %>'>
                                <%# Eval("File_name")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="تعديل">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImgBtnEdit" CommandName="EditItem" runat="server" ImageUrl="../Images/Edit.jpg"
                                CommandArgument='<%# Eval("proj_img_service_id") %>' />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="حذف">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImgBtnDelete" CommandName="RemoveItem" runat="server" ImageUrl="../Images/delete.gif"
                                Style="height: 22px" CommandArgument='<%# Eval("proj_img_service_id") %>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" />
                    </asp:TemplateField>
                </Columns>
