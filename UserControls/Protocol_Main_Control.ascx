<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Protocol_Main_Control.ascx.cs"
    Inherits="UserControls_Protocol_Main_Control" %>
                ...
                <table width="100%" style="line-height: 2; color: Black">
                        ...
                        <td dir="rtl" align="center" style="height: 61px">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="right" dir="rtl">
                                        <asp:Label ID="Label3" runat="server" CssClass="Label" Text=" المسمي : " />
                                    </td>
                                    <td align="right" dir="rtl">
                                    ...
                                    <td align="right" dir="rtl">
                                        <div>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label34" runat="server" CssClass="Label" Text="يوم  " />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label36" runat="server" CssClass="Label" Text="شهر  " />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label37" runat="server" CssClass="Label" Text="سنة  " />
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button runat="server" Text="..." ID="Button2" OnClick="btnCalc_Click" Width="20px" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label29" runat="server" CssClass="Label" Text="علاقة البروتوكول  " />
                                    </td>
                                    <td align="right">
                                        <asp:DropDownList ID="drop_relation"  runat="server" CssClass="drop" 
                                            AutoPostBack="True" onselectedindexchanged="drop_relation_SelectedIndexChanged">
                                           
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="lbl_prot" Visible="False" runat="server" CssClass="Label" 
                                            Text="البروتوكول  " />
                                    </td>
                                    <td align="right">
                                        <uc1:Smart_Search ID="smart_Protocol" Visible="False" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:Button runat="server" CssClass="Button" Text="جديد" ID="btn_New" Width="99px"
                        ...
                        <td>
                            <div id="div2" style="display: block" dir="rtl">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td align="right" dir="rtl">
                                            <asp:Label ID="Label27" runat="server" CssClass="Label" Text="مسئولية الجهة : " />
                                        </td>
                                        <td align="right" dir="rtl" colspan="3">
                                            <asp:TextBox ID="Txt_Resp" Height="80px" CssClass="Text" runat="server" TextMode="MultiLine"
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="GridView_Protocole_Committee" runat="server" AutoGenerateColumns="False"
                                            ...
                                            AllowPaging="true" AllowSorting="true" OnRowCommand="GridView_Protocole_Committee_RowCommand">
                                            <Columns>
