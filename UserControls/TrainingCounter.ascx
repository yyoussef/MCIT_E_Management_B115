            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="height: 50px">
                <tr bgcolor="#E6F3FF">
                    <td width="35" onmouseover="this.style.cursor='hand'" onclick="ChangeMeCase('trainingDiv','trainingImage');">
                        <img border="0" id="trainingImage" src="../Images/expand.gif"  />
                    </td>
                ...
                <table>
                    <tr id="tr_lnk_Tran_Request" runat="server" visible="true">
                        <td align="left" style="width: 368px">
                            <asp:Image ID="Image50" runat="server" ImageUrl="~/new_images/a1.gif" />
                        </td>
                        <td align="right" id="td" runat="server">
                            <asp:LinkButton ID="LinkButton68" OnClick="lnk_Tran_Request_Click" runat="server"
                                ...
                                <asp:LinkButton ID="LinkButton73" OnClick="lnk_Tran_Request_Click" runat="server"
                                    CssClass="link" Visible="true" Font-Underline="true" Text="طلب تدريب" Font-Size="20px"
                    ...
                    <tr id="tr_Train_New" runat="server">
                        <td align="left" style="width: 368px">
                            <asp:Image ID="Image51" runat="server" ImageUrl="~/new_images/a1.gif" />
                        </td>
                        <td align="right" id="td2" runat="server">
                            <asp:LinkButton ID="LinkButton71" OnClick="lnk_Tran_New_Click" runat="server" Font-Underline="True"
                                Font-Size="20px" ForeColor="#275078" CssClass="link" Font-Bold="true" Text="لديك عدد">
                                <asp:LinkButton ID="lnk_Tran_New" OnClick="lnk_Tran_New_Click" runat="server" CssClass="link"
                                    Font-Size="20px" Visible="true" Font-Underline="true" Text="0" ForeColor="red" />
                                <asp:LinkButton ID="LinkButton75" OnClick="lnk_Tran_New_Click" runat="server" CssClass="link"
                                    Visible="true" Font-Underline="true" Text=" تدريب جديد" Font-Size="20px" ForeColor="#275078"
                       ...
                       <tr id="tr1" runat="server">
                        ...
                        <td align="right" id="td1" runat="server">
                            <asp:LinkButton ID="LinkButton1" OnClick="lnk_Trainplan_New_Click" runat="server" Font-Underline="True"
                                Font-Size="20px" ForeColor="#275078" CssClass="link" Font-Bold="true" Text="لديك عدد">
                                <asp:LinkButton ID="lnk_trainplan" OnClick="lnk_Trainplan_New_Click" runat="server" CssClass="link"
                                    Font-Size="20px" Visible="true" Font-Underline="true" Text="0" ForeColor="red" />
                                <asp:LinkButton ID="LinkButton3" OnClick="lnk_Trainplan_New_Click" runat="server" CssClass="link"
                                    Visible="true" Font-Underline="true" Text="  خطط تدريبية" Font-Size="20px" ForeColor="#275078"
                                    Font-Bold="true" /></asp:LinkButton>
                            <br />
                        </td>
                    </tr>
