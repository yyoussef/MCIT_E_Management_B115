<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Evaluation_MainItems_Manager.ascx.cs"
    ...
    <table style="width: 100%" dir="rtl">
     ...
     <tr>
        <td align="center" colspan="3" style="height: 100px">
            <asp:Label ID="Label2" runat="server" CssClass="PageTitle" Text="عناصر التقييم الرئيسية للمديرين" />
        ...
        <tr>
            ...
            <td style="width: 576px">
                <asp:TextBox ID="txt_mainitem" runat="server"></asp:TextBox>
            </td>
            <td>
                
                 <input id="hidd_main_id" type="hidden" runat="server" />
                &nbsp;
            </td>
        </tr>
            ...
            <td colspan="2">
                ...
                <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand " runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Main_Item_Id" HeaderText=" رقم المسلسل" ControlStyle-Font-Size="X-Large"  Visible="false" />
