<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Commission_Grid_Page.ascx.cs"
    Inherits="UserControls_Commission_Grid_Page" %>
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbl_inbox_id" runat="server" Text='<%# Eval("ID") %>' Visible="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                    </Columns>
