<%@ Control Language="C#" AutoEventWireup="true" CodeFile="project_statistics_service.ascx.cs"
    Inherits="UserControls_project_statistics_service" %>
...
<table dir="rtl" style="line-height: 2; width: 99%;">
    <tr>
        <td align="center" colspan="4" style="height: 33px">
            <asp:Label ID="Label2" runat="server" CssClass="PageTitle" Text="ملفات احصائيات خدمات المشروع" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddl_service" AutoPostBack="true" runat="server" CssClass="drop"
                Width="200px" OnSelectedIndexChanged="ddl_service_SelectedIndexChanged">
    ...
    <tr>
        ...
        <td dir="rtl">
            ...
            <asp:RegularExpressionValidator ID="regexValidator" runat="server" ControlToValidate="FileUpload1"
                ErrorMessage="أدخل الملف صيغة PDF" Font-Bold="true" Font-Size="Medium" 
                ValidationExpression="(^.+\.(?:(?:[dD][oO][cC][xX]?)|(?:[pP][dD][fF]))$)">
            ...
            <asp:GridView ID="GrdView_Documents" runat="server" AutoGenerateColumns="False" CellPadding="3"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="الوثيقة">
                        <ItemTemplate>
                            <a href='<%# "ALL_Document_Details.aspx?type=statservice&id="+ Eval("proj_statistics_service_id") %>'>
                                <%# Eval("File_name")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="تعديل">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImgBtnEdit" CommandName="EditItem" runat="server" ImageUrl="../Images/Edit.jpg"
                                CommandArgument='<%# Eval("proj_statistics_service_id") %>' />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="حذف">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImgBtnDelete" CommandName="RemoveItem" runat="server" ImageUrl="../Images/delete.gif"
                                Style="height: 22px" CommandArgument='<%# Eval("proj_statistics_service_id") %>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" />
                    </asp:TemplateField>
                </Columns>
