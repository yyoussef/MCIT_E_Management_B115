                            ...
                            <ContentTemplate>
                                <table>
                                    <tr id="tr_smart_proj" runat="server" visible="False">
                                        <td runat="server">
                                            <asp:Label ID="Label443" runat="server" Text="المشروع :" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Type" runat="server" Width="319px" AutoPostBack="True"
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Source_Type" runat="server" Width="319px">
                                    ...
                                    <tr runat="server" id="tr_Inbox_In" style="display: none; width: 10px">
                                        <td style="width: 50px">
                                            <asp:Label ID="Label48" runat="server" Text="الادارة :" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_Date" runat="server" Width="107px"></asp:TextBox>
                                    ...
                                    <tr runat="server" id="tr_Related_Type">
                                        ...
                                        <td runat="server">
                                            <asp:DropDownList ID="ddl_Related_Type" runat="server" Width="319px"
...
>>>>>>> fe6fb27d413df3c7b0a730226354395082046154
                                        <td colspan="4" align="right" runat="server">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label7" runat="server" Text="جهة الورود :" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td colspan="2" style="display: none">
                                                        <asp:TextBox runat="server" ID="txt_New_Org" Width="300px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label26" runat="server" Text=" المرسل داخل الجهة ( صفته / شخصه ) :" />
                                                    </td>
                                                    <td>
                                    ...
                                    <tr runat="server" id="tr_Inbox_out_info">
                                        ...
                                        <td runat="server">
                                            <asp:TextBox ID="txt_Org_Out_Box_DT" runat="server" Width="107px"></asp:TextBox>
                                        ...
                                        <td align="right" runat="server" colspan="3">
                                            <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 100px; border: 1px solid #bbb;margin:7px"
                                                ...
                                                <asp:CheckBoxList ID="Chk_main_cat" CellPadding="5" AutoPostBack="True" CellSpacing="5"
                                                    RepeatColumns="6" Font-Size="Small" RepeatDirection="Horizontal"
                                    ...
                                    <tr id="sub_cat_subj" runat="server">
                                        <td runat="server">
                                            <asp:Label ID="Label45" runat="server" Text="التصنيف الفرعى :" />
                                        </td>
                                        <td colspan="3" align="right" runat="server">
                                            <asp:CheckBoxList ID="Chk_sub_cat" CellPadding="5" CellSpacing="5" RepeatColumns="6"
                                                Font-Size="Small" RepeatDirection="Horizontal" DataTextField="Name"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text="الموضوع :" />
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txt_Subject" runat="server" Height="70px" Width="90%"
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label19" runat="server" Text="الوثيقة:" Width="135px" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Original_Or_Attached" runat="server" Width="319px">
                        ...
                        <cc1:TabPanel ID="TabPanel_Visa" runat="server">
                            ...
                            <ContentTemplate>
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label28" runat="server" Text="تاريخ التاشيرة :" Width="135px" />
                                            <input type="hidden" runat="server" id="hidden_Visa_Id"></input>
                                        </td>
                                        <td dir="rtl">
                                            <asp:TextBox ID="txt_Visa_date" runat="server" Width="107px"></asp:TextBox><cc1:FilteredTextBoxExtender
                                        ...
                                        <td align="right" dir="rtl">
                                            <asp:Label ID="Label29" runat="server" Text="درجة الأهمية: " Width="100px" />
                                        </td>
                                        <td>

                                            <asp:DropDownList ID="ddl_Important_Degree" runat="server" Width="150px">
                                    ...
                                    <tr>
                                        ...
                                        <td dir="rtl">
                                            <asp:TextBox ID="txt_Dead_Line_DT" runat="server" Width="107px"></asp:TextBox><cc1:FilteredTextBoxExtender
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddl_Visa_Goal_ID" runat="server" Width="150px">
                               ...
                               <td colspan="3">
                                    <asp:DropDownList ID="ddl_sectors2" AutoPostBack="True" OnSelectedIndexChanged="ddl_sectors2_SelectedIndexChanged"
                                        runat="server"  Width="314px" DataTextField="Sec_name" DataValueField="Sec_id">
                                     </asp:DropDownList>
                               </td>
                             </tr>--%>
                                    <tr>
                                ...
                                <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label30" runat="server" Text="الادارة :" />
                                        </td>
                                        <td colspan="3">
                                    ...
                                    <tr id="tr_emp_list" runat="server">
                                        ...
                                        <td align="right" runat="server">
                                            <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px; border: 1px solid #bbb;"
                                                dir="rtl">
                                                <asp:CheckBox ID="chk_ALL" RepeatDirection="Horizontal"
                                                    Text="اختر الكل" AutoPostBack="True" runat="server" OnCheckedChanged="chk_ALL_CheckedChanged"></asp:CheckBox>
                                        ...
                                        <td runat="server">
                                            ...
                                            <asp:ListBox ID="lst_emp" runat="server" Height="289px" Width="390px" Style="background-color: #F9fdff;"></asp:ListBox>
                                        ...
                                        <td align="right" colspan="3" runat="server">
                                            <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px"
                                                ...
                                                <asp:CheckBoxList ID="chklst_Visa_Emp" CellPadding="5" CellSpacing="5" RepeatColumns="6"
                                                    Font-Size="Small" RepeatDirection="Horizontal" DataTextField="code"
                                                    DataValueField="ID" runat="server">
                                                </asp:CheckBoxList>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="vertical-align: top;">
                                            <asp:Label ID="Label3" runat="server" Text="ملف الحفظ :" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Visa_Satus" runat="server" Width="319px">
                                    ...
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label15" runat="server" Text="الوثيقة:" Width="135px" />
                                        </td>
                        ...
                        <cc1:TabPanel ID="TabPanel_Visa_Folow" runat="server">
                            <HeaderTemplate>
                                <asp:Label ID="Label6" runat="server"  Text="المسير" />
                            </HeaderTemplate>
                            <ContentTemplate>
                                <table width="100%">
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label36" runat="server" Text="المسئول عن التنفيذ:"
                                                Width="135px" />
                                            <input type="hidden" runat="server" id="hidden_Follow_ID"></input>
                                        </td>
                                        <td dir="rtl">
                                            <asp:DropDownList ID="ddl_Visa_Emp_id" runat="server" Width="319px">
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td align="right" dir="rtl">
                                            <asp:Label ID="Label37" runat="server" Text="وصف المتابعة: " />
                                        </td>
                                        <td>
                                        ...
                                        <td colspan="2">
                                            <asp:Label ID="Label38" runat="server" Width="293px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label39" runat="server" Text="تاريخ المتابعة :" Width="135px" />
                                        </td>
                                        <td dir="rtl">
                                            <asp:TextBox ID="txt_Follow_Date" runat="server" Width="105px"></asp:TextBox><cc1:FilteredTextBoxExtender
                                    ...
                                    <tr>
                                        <td align="right" width="150px">
                                            <asp:Label ID="Label40" runat="server" Text="الوثيقة:" Width="135px" />
                                        </td>
                                        <td dir="rtl" colspan="3">
