<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewProject_Inbox.ascx.cs"
    Inherits="UserControls_ViewProject_Inbox" %>
                                ...
                                <td valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td dir="rtl" valign="top" align="right">
                                                <asp:Label ID="Label19" runat="server" CssClass="Label" Text=" نوع الارتباط المباشر :" />
                                            </td>
                                            <td dir="rtl" valign="top" align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="15">
                                                ...
                                                <%--<asp:Label ID="lbl_letter" runat="server"  Text="عنوان الخطاب " CssClass="Label" Font-Bold="False" ForeColor="Black"  />--%>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td dir="rtl" valign="top" align="right">
                                                <asp:Label ID="Label8" runat="server" CssClass="Label" Text="جهة الورود :" Font-Bold="true" />
                                            </td>
                                            <td valign="top" width="20">
                                            </td>
                                            <td dir="rtl" valign="top" align="right">
                            ...
                            <tr id="tr_mngr1" runat="server">
                                <td colspan="4">
                                    <table style="width: 100%;">
                                        <%-- <tr>
                                    <td>
                                        <asp:Label ID="Label7" runat="server" CssClass="Label" Text="القطاع :" />
                                    </td>
                                    <td colspan="3">
                            ...
                            <tr>
                                <td colspan="4">
                                    <asp:GridView ID="GridView_Visa" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        OnPageIndexChanging="GridView_Visa_PageIndexChanging">
                                        <Columns>
                        ...
                        <table style="line-height: 2; width: 100%">
                            ...
                            <tr>
                                <td align="center" colspan="4" dir="rtl">
                                    <asp:LinkButton ID="lnkBtnUnderStudy" runat="server" CssClass="Button" Text="تحت الدراسة"
                                        Font-Bold="true" OnClick="lnkBtnUnderStudy_Click" Visible="false">
                                    </asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="4" dir="rtl">
                                    <asp:Button runat="server" CssClass="Button" Text="إغلاق الموضوع" ID="btn_close_inbox"
                                        OnClick="btn_close_inbox_Click" Width="150px" Visible="false" />
                                </td>
                            </tr>
                        </table>
                    </div>
