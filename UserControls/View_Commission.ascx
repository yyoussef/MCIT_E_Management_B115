<%@ Control Language="C#" AutoEventWireup="true" CodeFile="View_Commission.ascx.cs"
    Inherits="UserControls_View_Commission" %>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="1" dir="rtl" valign="top" align="right">
                                                    <asp:Label ID="Label1" runat="server" CssClass="Label" Text="الكود :" Font-Size="22px" />
                                                </td>
                                                <td colspan="1" dir="rtl" valign="top" align="right" width="95%">
                                                    <asp:Label ID="lblCode" runat="server" CssClass="Label" Font-Size="20px" ForeColor="Black"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="1" dir="rtl" valign="top" align="right">
                                                    <asp:Label ID="Label3" runat="server" CssClass="Label" Text="التاريخ :" Font-Size="22px" />
                                                </td>
                                                <td colspan="1" dir="rtl" valign="top" align="right" width="95%">
                                                    <asp:Label ID="lblLetterDate" runat="server" CssClass="Label" Font-Size="20px" ForeColor="Black"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                      ...
                      <tr>
                       <td valign="top">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td dir="rtl" valign="top" align="right" width="20%">
                                        <asp:Label ID="lbl_close" runat="server" CssClass="Label" Text="الموظف المسئول عن اغلاق التكليف  :"  Visible="false"    />
                                        
                                        
                                    </td>
                                    <td dir="rtl" valign="top" align="right">
                                    
                                    <asp:Label ID="lbl_closeperson" runat="server" CssClass="Label" Font-Bold="False" ForeColor="Black" Visible="false"></asp:Label>
                    ...
                    <tr id="tr_mngr1" runat="server">
                        <td colspan="4">
                            <table style="width: 100%;">
                             ...
                             <%--  <tr>
                                            <td>
                                                <asp:Label ID="Label1" runat="server" CssClass="Label" Text="القطاع :" />
                                            </td>
                                            <td colspan="3">
                                ...
                                <tr id="tr_emp_list" runat="server">
                                    ...
                                    <td align="right" runat="server">
                                        <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px;
                                            ...
                                            <asp:CheckBoxList ID="chklst_Visa_Emp_All" CellPadding="5"
                                                CellSpacing="5" RepeatColumns="2" CssClass="Label" Font-Size="Small" RepeatDirection="Horizontal"
                                ...
                                <tr id="tr_old_emp_resp" runat="server">
                                    ...
                                    <td align="right" width="100%" colspan="3">
                                        <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px;
                                            ...
                                            <asp:CheckBoxList ID="chklst_Visa_Emp" CellPadding="5" CellSpacing="5" RepeatColumns="5"
                                ...
                                <tr Visible="false" >
                                    <td>
                                        <asp:Label ID="Label8" runat="server" CssClass="Label" Text="الموظف المسئول عن اغلاق التكليف  :"  Visible="false"  />
                                    </td>
                                    <td colspan="3">
                                        <asp:DropDownList ID="drop_Resp_close_emp" runat="server" CssClass="drop" Width="300px" Visible="false" >
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:GridView ID="GridView_Visa_Follow" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="الوثيقة" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <a href='<%# "ALL_Document_Details.aspx?type=com_follow&id="+ Eval("Follow_ID") %>'>
                                                <%# Eval("File_name")%></a>
                                        </ItemTemplate>
                    ...
                    <tr>
                        <td align="center" colspan="4" dir="rtl">
                            <asp:Button runat="server" CssClass="Button" Text="انهاء حالة التأخير" ID="btn_end_late"
                                OnClick="btn_end_late_Click" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="4" dir="rtl">
                            <asp:Button runat="server" CssClass="Button" Text="إغلاق الموضوع" ID="btn_close_com"
                                OnClick="btn_close_com_Click" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
...
<table dir="rtl" style="line-height: 2; width: 99%;" runat="server" id="TemplateA" visible="false" >
    <tr bgcolor="#E6F3FF">
        <td valign="top" align="right" width="95%">
            <table width="100%" cellpadding="0" cellspacing="0" style="height: 50px">
                <tr bgcolor="#E6F3FF">
...
<table dir="rtl" style="line-height: 2; width: 99%;" runat="server" id="TemplateE" visible="false" >
    <tr bgcolor="#E6F3FF">
        <td valign="top" align="right" width="95%">
            <table width="100%" cellpadding="0" cellspacing="0" style="height: 50px">
                <tr bgcolor="#E6F3FF">
