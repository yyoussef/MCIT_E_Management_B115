<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Agreements_work_order.ascx.cs" Inherits="UserControls_Agreements_work_order" %>
                    ...
                    <tr>
                        <td dir="rtl" align="center" style="height: 61px">
                            <table width="100%">
                                ...
                                <tr runat="server" id="tr_ddl_Period_Sources" visible="false">
                                    <td>
                                        <asp:Label ID="Label34" runat="server" CssClass="Label" Text=" اختر اتفاقية : " />
                                    </td>
                                     <td align="right" colspan="3">
                                        <asp:DropDownList ID="ddl_Period_Sources" runat="server" Width="600px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label27" runat="server" CssClass="Label" Text=" القائم بالتنفيذ : " />
                                    </td>
                                    <td align="right"> 
                                         <asp:DropDownList ID="ddlExcution" runat="server" CssClass="drop">
                                            <asp:ListItem Selected="True" Value="0" Text="... اختر القائم بالتنفيذ ...">
                                            </asp:ListItem>
                                            <asp:ListItem Value="1" Text="MCIT"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="MSAD"></asp:ListItem>
                                            </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:DropDownList ID="ddl_Tender_Year" runat="server" CssClass="drop">
                                            ...
                                            <asp:ListItem Text="2010" Selected="True"></asp:ListItem>
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            ...
                            <asp:Button ID="btn_Letter" OnClick="btn_Letter_Click" Text="حفظ" runat="server"
                                ValidationGroup="D" CssClass="Button"  Enabled="false"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
