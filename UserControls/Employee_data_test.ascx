<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Employee_data_test.ascx.cs"
                        ...
                        <cc1:TabPanel ID="TabPanel_dtl" runat="server">
                            ...
                            <ContentTemplate>
                                <table>
                                    ...
                                    <tr>
                                      <td>
                                            <asp:Label ID="Label6" runat="server" Text="  الهيكل التنظيمي :" CssClass="Label" ForeColor="#808080" font-underline="false"></asp:Label>
                                        </td>
                                     <td>
