...
<table dir="rtl" style="line-height: 2; width: 99%;" >
    ...
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label9" runat="server"  Text="التصنيف الرئيسي:" />
        </td>
        <td colspan="2">
    ...
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label12" runat="server"  Text="التصنيف الفرعي:" />
        </td>
        <td colspan="2">
    ...
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label1" runat="server"  Text="كلمة في الكود:" />
        </td>
        <td colspan="2">
            <asp:TextBox runat="server"  ID="Txtcode" Width="323px"></asp:TextBox>
        </td>
    </tr>
  
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label6" runat="server"  Text="رقم صادر الجهة:" />
        </td>
        <td colspan="2">
            <asp:TextBox runat="server"  ID="txt_out_code" Width="323px"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label4" runat="server"  Text="كلمة في الموضوع:" />
        </td>
        <td colspan="2">
            <asp:TextBox runat="server"  ID="Inbox_name_text" Width="323px"></asp:TextBox>
        </td>
    </tr>
     ...
     <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="lbl_word_visa" runat="server"  Text="كلمة في التأشيرة:" />
        </td>
        <td colspan="2">
            <asp:TextBox runat="server"  ID="txt_word_visa" Width="323px"></asp:TextBox>
        </td>
    </tr>
     ...
     <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="lbl_word_notes" runat="server"  Text="كلمة في الملاحظات:" />
        </td>
        <td colspan="2">
            <asp:TextBox runat="server"  ID="txt_word_notes" Width="323px"></asp:TextBox>
        </td>
    </tr>
      ...
      <tr>
       <td>
             <asp:Label ID="lbl_emp" runat="server"  Text="الموظف :" />
      </td>
       <td>
    ...
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label3" runat="server"  Text="جهة الورود : "></asp:Label>
        </td>
    ...
    <tr>
       <%-- <td align="right" dir="rtl" style="width: 142px">
            <asp:Label ID="Label8" runat="server"  Text=" االادارة : "></asp:Label>
        </td>
        <td align="right" dir="rtl" colspan="2">
            <uc1:Smart_Search ID="Smart_Search_depts" runat="server" />
        </td>--%>
         <td align="right" dir="rtl">
                                    <asp:Label ID="txt_Dept_ID_Txt" runat="server" ></asp:Label></td></tr>
    <tr>
                                            <td>
    ...
    <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label5" runat="server"  Text="تاريخ الورود:" />
        </td>
        <td >
            <asp:Label ID="Label13" runat="server"  Text="من:" />
              <asp:TextBox ID="Inbox_date_from" runat="server" ></asp:TextBox>
            ...
            <asp:TextBox ID="Inbox_date_to" runat="server" ></asp:TextBox>
      ...
      <tr>
        <td align="right" dir="rtl" >
            <asp:Label ID="Label10" runat="server"  Text="تاريخ صادر الجهة:" />
        </td>
        <td >
            <asp:Label ID="Label11" runat="server"  Text="من:" />
                  <asp:TextBox ID="Outbox_date_from" runat="server" ></asp:TextBox>
            ...
            <asp:TextBox ID="Outbox_date_to" runat="server" ></asp:TextBox>
    ...
    <tr>
        <td colspan="3">
            ...
            <div align="center">
                ...
                <%--<asp:Button ID="Button1" runat="server" Text="تصدير الي إكسل" Width="130px" 
