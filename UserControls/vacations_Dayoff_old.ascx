<%@ Control Language="C#" AutoEventWireup="true" CodeFile="vacations_Dayoff_old.ascx.cs" Inherits="UserControls_vacations_Dayoff_old" %>
        ...
        <tr>
            <td  align="center" colspan="2">
                <asp:Label ID="lblMastertitle" runat="server" CssClass="PageTitle" Font-Bold="True"
                    Text="عمل في أيام عطلة سابقة"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center" style="direction: ltr; text-align: left;">
