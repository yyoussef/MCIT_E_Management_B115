<%@ Control Language="C#" AutoEventWireup="true" CodeFile="vacations_report.ascx.cs" Inherits="UserControls_vacations_report" %>
                    ...
                    <table style="line-height: 2; width: 107%">
                        <tr>
                            ...
                            <td style="height: 30px">
                                ...
                                <asp:LinkButton ID="lnk_errand_det" runat="server" CssClass="Text" Font-Bold="False"
                                    OnClick="errand_DetailsLB_Click">مفصل المأموريات</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td width="28">
                            ...
                            <td style="height: 30px">
                                ...
                                &nbsp;<asp:LinkButton ID="lnk_errand_sum" runat="server" Font-Bold="False" OnClick="errand_SumLB_Click"
