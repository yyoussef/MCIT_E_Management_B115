...
Partial Class UserControls_ProjectInfo
    ...
    Private Sub MOnMember_Data(ByVal Value As String)
        ...
        If CDataConverter.ConvertToInt(Value) > 0 Then
            ...
            If _dt.Rows.Count > 0 Then
                ...
                txt_cause.Text = _dt.Rows(0)("project_cause").ToString()

                txt_innovation.Text = _dt.Rows(0)("project_innovation").ToString()
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString("mode") = "edit" Then
                ...
                If _dt.Rows.Count > 0 Then
                    ...
                    If Not _dt.Rows(0)("project_cause") Is DBNull.Value Then
                        txt_cause.Text = _dt.Rows(0)("project_cause")
                    End If

                    If Not _dt.Rows(0)("project_innovation") Is DBNull.Value Then
                        txt_innovation.Text = _dt.Rows(0)("project_innovation")
                    End If
                    ...
                    If _dt.Rows(0)("proj_sug_type") Is DBNull.Value Then
                        DDLSuggestType.SelectedValue = _dt.Rows(0)("proj_sug_type")
                    End If
                    'comment SRS
...
#Region "Save Data"
    ...
    Private Sub SaveDataForClasses(Optional ByVal ID As Integer = 0)
        Dim Bt(0) As Byte
        Dim d As Decimal = Decimal.Parse(txtCoast.Text)
        Try
            ...
            If canEdit Then
                ...
                End If
                hidden_success.Value = "1"
            End If
        Catch ex As Exception
            lblPageStatus.Visible = True
            lblPageStatus.Text = ex.Message
            hidden_success.Value = "0"
            Return
        End Try
    End Sub
#End Region
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnSave.Click
        ...
        If BtnSave.CommandArgument = "edit" Then
            If Valid() Then
                ...
                If hidden_success.Value = "1" Then
                    lblPageStatus.Text = "تم التعديل بنجاح"
                Else
                    lblPageStatus.Text = "لم يتم التعديل"
                End If
        ...
        Else
            lblPageStatus.Visible = True
            lblPageStatus.Text = "عفوا, لم يتم الحفظ"
        End If
