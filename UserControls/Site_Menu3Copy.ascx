<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Site_Menu3Copy.ascx.cs" Inherits="UserControls_Site_Menu3Copy" %>
...
<div id="Div_Main" runat="server">
 <table border="0" id="myMenu" class="nav">
  ...
  <div id="MangerDepDiv" runat="server">
    <ul id="verticalmenu"  class="sidemenu">
                    ...
                    <li id="Li61" runat="server" visible="false">
                        <a href="Default.aspx?curProj=1">المشروعات الجارية</a>
                        <input type="hidden" runat="server" id="hidden64" value="79" />
                    </li>
                    <li id="Li83" runat="server" visible="false">
                        <a href='<%="ProjectGeneralData.aspx?mode=edit&Proj_id=" + Session_CS.Project_id.ToString()%>' id="ahref" runat="server">البيانات الاساسيه للمشروع</a>
                    ...
                    <li id="Li69" runat="server" visible="false">
                        ...
                        <ul>
                            ...
                            <li><a href=" ActivitiesEditing_Station.aspx">تحديث موقف متابعة المشــــروع </a></li>
                    ...
                    <li id="Li66" runat="server" visible="false">
                        ...
                        <ul >
                            ...
                            <li><a href="Project_meetings.aspx">اجتماعات </a></li>
                            <li><a href="Project_event.aspx">أحداث </a></li>
                    ...
                    <li id="Li67" runat="server" visible="false">
                        ...
                        <ul >
                            ...
                            <li ><a href="Outbox_Search.aspx">صادر</a></li>
                            <li><a href="Project_meetings_search.aspx">اجتماعات </a></li>
                    ...
                    <li id="Li71" runat="server" visible="false">
                        ...
                        <ul >
                            ...
                            <li><a href="project_video_service.aspx">مكتبة الفيديو</a></li>
                        </ul>
                    </li>
                    ...
                    <li id="Li78" runat="server" visible="false">
                    ...
                    <li id="Li34" runat="server" visible="false">
                    ...
                    <li id="Li33" runat="server" visible="false">
                        <a href="MMallReports.aspx">تقارير</a>
                    ...
                    <li>
                        ...
                        <ul >
                            <li>
                                <a href="Deprt_Documnts.aspx">
                                    إضافة وثيقة
                                </a>
                            </li>
                            <li>
                                <a href="Deprt_Documnts_Search.aspx">
                                    بحث عن وثيقة
                                </a>
                            </li>
                            <li></li>
                    ...
                    <%--
                    <li id="li44" visible="false" runat="server">
                        <a href="Training_Reports.aspx">التقارير </a>
                    ...
                    <li id="Li24" runat="server" visible="false">
                    ...
                    <li id="Li31" runat="server" visible="false">
                    ...
                    <li id="Mod_Training_10" runat="server">
                        ...
                        <ul >
                            ...
                            <li id="Li96" runat="server">
                                <a href="Training_view_userrequest.aspx">الدورات السابقة </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li id="Mod_Evaluation_11" runat="server">
                        ...
                        <ul >
                            ...
                            <%--
                            <li>
                                <a href="Eval_Reports.aspx">
                                    تقارير تقييم أداء موظف
                                </a>
                            </li>--%>
                            <li id="LI85" runat="server">
                                <a href="../MainForm/Eval_For_Manager.aspx">تقييم أداء مدير</a>
                            ...
                            <%--
                            <li>
                                <a href="../MainForm/Eval_Report_Manager.aspx">
                    ...
                    <li id="Mod_Vacation_9" runat="server">
                        ...
                        <ul >
                            ...
                            <li id="lip2" runat="server">
                                <a href="vacations_errand.aspx">المأموريات</a>
                            </li>
                            <li id="lip3" runat="server">
                                <a href="vacations_DayOff.aspx">عمل يوم عطلة</a>
                            </li>
                            <li id="li_perm" runat="server">
                                <a href="vocations_permission.aspx">إذن </a>
                            </li>
                            <li id="Li313" runat="server" visible="false">
                    ...
                    <li id="li86" runat="server" visible="false">
                        ...
                        <a href="../MainForm/Memo_Upload.aspx">إدارة مذكرات العرض</a>
                    </li>
                    <li id="Li84" runat="server" visible="false">
                    ...
                    <li><a href="ChangePassword.aspx">تعديل كلمة المرور</a> </li>
