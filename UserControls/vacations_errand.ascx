<%@ Control Language="C#" AutoEventWireup="true" CodeFile="vacations_errand.ascx.cs" Inherits="UserControls_vacations_errand" %>
                 ...
                 <tr>
                    ...
                    <td align="right" style="direction: ltr" width="50%">
                       &nbsp; <asp:Button ID="BtnRequests" runat="server" CssClass="Button" 
                            Text="المأموريات" Width="110px" onclick="BtnRequests_Click" 
                            Visible="False" />
                    </td>
                </tr>
                <tr>
                    <td align="center" class="Text" dir="rtl" colspan="2">
                        <asp:GridView ID="requests" runat="server" AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="False"
                            ...
                            GridLines="Vertical" AllowPaging="true" OnPageIndexChanging="gvMain_PageIndexChanging"  PageSize="10">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="الجهة" ItemStyle-Width="35%" HeaderStyle-Width="35%" HeaderStyle-Font-Size="Large"
                                    ...
                                    <HeaderStyle Font-Size="Large" Width="35%" />
                                    <ItemStyle Font-Size="Large" Width="35%" />
                                </asp:TemplateField>
