<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Project_Inbox_Minister.aspx.cs" Inherits="WebForms_Project_Inbox_Minister" Title="تأشيرة الوزير" %>
    ...
    <table dir="rtl" style="line-height: 2; width: 99%;">
        <tr>
            <td align="center" colspan="4" style="height: 33px">
                <asp:Label ID="Label2" runat="server" CssClass="PageTitle" Text="تأشيرة الوزير" />
            </td>
        </tr>
        <tr>
            ...
            <td colspan="4">
                <cc1:TabContainer runat="server" ID="TabPanel_All" Height="1500px" ActiveTabIndex="0">
                    <cc1:TabPanel ID="TabPanel_dtl" runat="server">
                        <HeaderTemplate>
                            <asp:Label ID="Label14" runat="server" CssClass="Label" Font-Size="11px" Text="تفاصيل التأشيرة" />
                        ...
                        <ContentTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_Type" runat="server" CssClass="drop" Width="319px" AutoPostBack="True"
                                            ...
                                            <asp:ListItem Text="تأشيرة" Value="2" Selected="True"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_Source_Type" runat="server" CssClass="drop" Width="319px">
                                            ...
                                            <asp:ListItem Text="الفاكس" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_Related_Type" runat="server" CssClass="drop" Width="319px"
                                            ...
                                            <asp:ListItem Text="تأشيرة جديدة" Value="1" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="رد على مذكرة عرض" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td colspan="2">
                                ...
                                <tr runat="server" id="tr_Inbox_out">
                                    <td colspan="4" align="right" runat="server">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label7" runat="server" CssClass="Label" Text="جهة التأشيرة :" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label26" runat="server" CssClass="Label" Text="المرسل داخل الجهة :" />
                                                </td>
                                                <td>
                                ...
                                <tr runat="server" id="tr_Inbox_In" visible="False">
                                    <td colspan="4" align="right" runat="server">
                                        <table>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td id="Td2" align="right" runat="server" colspan="3">
                                        <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 100px"
                                            ...
                                            <%--<asp:CheckBox ID="Chk_ALL_cat" CssClass="Label" Font-Size="Small" RepeatDirection="Horizontal"
                                            Text="اختر الكل" AutoPostBack="True" runat="server" OnCheckedChanged="Chk_ALL_cat_CheckedChanged">
                                        </asp:CheckBox>--%>
                                ...
                                <tr>
                                    ...
                                    <td id="Td4" colspan="3" align="right" runat="server">
                            ...
                            <table width="100%">
                                <tr>
                                    <td align="right" width="150px">
                                        ...
                                        <input type="hidden" runat="server" id="hidden_Inbox_OutBox_File_ID" />
                                    </td>
                                    <td dir="rtl">
                    ...
                    <cc1:TabPanel ID="TabPanel_Visa" runat="server">
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                <tr id="tr_dr_hesham_Visa" runat="server" visible="true">
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <%--<uc1:Smart_Search ID="Smart_Visa_Emp" runat="server" />--%>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <fieldset>
                                            <legend>
                                                <asp:Label ID="Label1" runat="server" CssClass="Label" Text="المتابعة" />
                                            </legend>
                                            <table>
                                                <%-- <tr>
                                                    <td>
                                                        <asp:Label ID="Label3" runat="server" CssClass="Label" Text="الإدارة التابع لها :" />
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="ddl_Follow_Up_Dept_ID" AutoPostBack="true" OnSelectedIndexChanged="ddl_Follow_Up_Dept_ID_SelectedIndexChanged"
                                                            runat="server" CssClass="drop" Width="314px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label6" runat="server" CssClass="Label" Text="المسئول عن المتابعة :" />
                                                    </td>
                                                    <td>
                                                        <uc1:Smart_Search ID="Smart_Follow_Up_Emp_ID" runat="server" />
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label13" runat="server" CssClass="Label" Text="موقف المتابعة :" />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txt_Follow_Up_Notes" runat="server" CssClass="Text" Width="293px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                    </td>
                                                    <td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="GridView_Visa" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            Font-Size="17px" AllowPaging="true" AllowSorting="true" OnRowDataBound="GridView_Visa_rw_data_bound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText=" ارسال إيميل" ItemStyle-Width="20px">
                                                    <ItemTemplate>
                    ...
                    <cc1:TabPanel ID="TabPanel_Visa_Folow" runat="server">
                        <HeaderTemplate>
                            <asp:Label ID="Label6" runat="server" CssClass="Label" Font-Size="11px" Text="متابعة التوزيعات" />
                        </HeaderTemplate>
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                ...
                                <%--<tr>
                                <td>
                                    <asp:Label ID="Label44" runat="server" CssClass="Label" Text="التوقيت : " />
                                </td>
                                <td colspan="3" align="right">
                                    <div>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label45" runat="server" CssClass="Label" Text="دقيقة  " />
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label46" runat="server" CssClass="Label" Text="ساعة  " />
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label47" runat="server" CssClass="Label" Text="التوقيت  " />
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txt_minute" runat="server" Height="20px" MaxLength="2" Width="30px"
                                                        CssClass="Text"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txt_hr" runat="server" Height="20px" MaxLength="2" Width="30px"
                                                        CssClass="Text"></asp:TextBox>
                                                </td>
                                                <td>
                                                     <asp:TextBox ID="txt_Period_Year" runat="server" Height="20px" Width="60px" MaxLength="4"
                                                            CssClass="Text"></asp:TextBox>
                                                    <asp:DropDownList ID="Drop_hr" runat="server" CssClass="drop" Width="70px">
                                                        <asp:ListItem Text="اختر.." Value="0"></asp:ListItem>
                                                        <asp:ListItem Text="صباحا" Value="1"></asp:ListItem>
                                                        <asp:ListItem Text="مساءا" Value="2"></asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RangeValidator ControlToValidate="Drop_hr" ErrorMessage="يجب اختيار التوقيت صباحا أو مساءا"
                                                        ID="RangeValidator1" Type="Integer" runat="server" Display="Dynamic" MaximumValue="1000000"
                                                        MinimumValue="1" ValidationGroup="VF">*</asp:RangeValidator>
                                                </td>
                                                <td>
                                                    <asp:Button runat="server" Text="..." ID="Button3" OnClick="btnCalc_Click" Width="20px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <asp:GridView ID="GridView_Visa_Follow" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="حذف" ItemStyle-Width="20px">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="ImgBtnDelete" CommandName="RemoveItem" runat="server" ImageUrl="../Images/delete.gif"
                                                            Style="height: 22px" CommandArgument='<%# Eval("Follow_ID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <PagerStyle CssClass="pgr" />
