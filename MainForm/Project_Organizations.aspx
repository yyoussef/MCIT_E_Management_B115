<%@ Page Language="VB" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="false" CodeFile="Project_Organizations.aspx.vb" Inherits="WebForms_Project_Organizations" 
  Title="الجهــــــــات المستفيـــــدة" %>
    ...
    <table style="line-height: 2; width: 98%;" align="right">
        <tr>
            <td dir="rtl" align="center">
                <asp:Label ID="lblMastertitle" runat="server" CssClass="PageTitle" Text=" الجهــــــــات المستفيـــــدة" Visible="false" ></asp:Label>
                <asp:Label ID="lblexec" runat="server" CssClass="PageTitle" Text=" الجهــــــــات المنفذة" Visible="false" ></asp:Label>
                        ...
                        <td>
                            <table width="100%" align="right">
                                ...
                                <tr>
                                    ...
                                    <td align="right" style="width: 387px" >
                                        <asp:TextBox ID="txtphone" runat="server" CausesValidation="True" CssClass="Text" MaxLength="15"/>
                                        <cc1:FilteredTextBoxExtender ID="txtphone_filtered" runat="server" FilterType="Custom" ValidChars="0987654321-()+" TargetControlID="txtphone" />
                                    </td>
                                    <td align="right" dir="rtl" style="width: 89px" >
                                    ...
                                    <td align="right"  >
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="txtmobile_filtered" runat="server" FilterType="Custom" ValidChars="0987654321-()+" TargetControlID="txtmobile" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" style="width: 136px;" dir="rtl">
                                    ...
                                    <asp:TemplateField HeaderText="حذف" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ImgBtnDelete" runat="server" ImageUrl="../Images/delete.gif"
                                                OnClick="ImgBtnDelete_Click" Style="height: 22px" CommandArgument='<%# Eval("POrg_id") %>' OnClientClick="if (confirm('هل تود الحذف نهائياً') == false) return false;" />
                                        </ItemTemplate>
