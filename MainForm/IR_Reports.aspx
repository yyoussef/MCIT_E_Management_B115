<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="IR_Reports.aspx.cs" Inherits="WebForms_IR_Reports" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   function ChangeMeCase(divid, imgid) {
    ...
    <table style="width: 100%; display: block; height: 238px; line-height: 2;" id="tbl_Report"
        ...
        <tr style="width: 100%" id="tr_indicators" runat="server">
        ...
        <tr id="general_tr_reports" runat="server">
            <td style="width: 288px">
                    ...
                    <table style="line-height: 2; width: 107%">
                        <tr>
                            ...
                            <td style="height: 30px">
                                ...
                                <asp:LinkButton ID="emp_followsLB" runat="server" CssClass="Text" Font-Bold="False"
                                    OnClick="emp_followsLB_Click">متابعة العاملين</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td width="28">
                            ...
                            <td style="height: 30px">
                                ...
                                <asp:LinkButton ID="inbox_LB" runat="server" CssClass="Text" Font-Bold="False"
                                    OnClick="inbox_LB_Click"> ملخص الوارد </asp:LinkButton>
                            </td>
                        </tr>
                         <tr>
                            <td width="28">
                            ...
                            <td style="height: 30px">
                                ...
                                <asp:LinkButton ID="inbox_minister_LB" runat="server" CssClass="Text" Font-Bold="False"
                                    OnClick="inbox_minister_LB_Click"> ملخص تأشيرة الوزير </asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <div id="Div_emp" runat="server" style="display: none">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td align="right" width="110px" style="height: 44px">
                    <asp:Label ID="Label18" runat="server" Text="الموظف : " Font-Names="Arial" Font-Size="20px"
                        ForeColor="#1F4569" Font-Bold="false"></asp:Label>
                </td>
                <td align="right" valign="middle" style="height: 44px" dir="rtl">
                    <%--<asp:DropDownList ID="DropProj" runat="server" AutoPostBack="True" Font-Bold="False"
    ...
    <div id="Div_Follow_Date" runat="server" style="display: block">
        <table cellpadding="0" cellspacing="0">
            <tr visible="true">
            ...
            <tr>
                <td align="right" dir="rtl">
                    <asp:Label ID="Label20" runat="server" Font-Bold="False" Text="تاريخ المتابعة -البداية :"
                        Font-Names="Arial" Font-Size="20px" ForeColor="#1F4569"></asp:Label>
                    <asp:TextBox ID="Follow_Date_from" runat="server" Font-Names="Arial" Font-Size="20px"
                        ForeColor="#1F4569" Font-Bold="True" Width="129px"></asp:TextBox>
                    <cc1:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="Follow_Date_from"
                    ...
                    <br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="Follow_Date_from"
                ...
                <td align="right">
                    <asp:Label ID="Label21" runat="server" Font-Bold="False" Text="تاريخ المتابعة -النهاية :"
                        Font-Names="Arial" Font-Size="20px" ForeColor="#1F4569"></asp:Label>
                    <asp:TextBox ID="Follow_Date_to" runat="server" Font-Bold="True" Height="29px" Width="128px"
                        Font-Names="Arial" Font-Size="20px" ForeColor="#1F4569"></asp:TextBox>
                    <cc1:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="Follow_Date_to"
                    ...
                    <asp:ImageButton ID="ImageButton4" runat="Server" ImageUrl="~/images/Calendar_scheduleHS.png"
                        AlternateText="اضغط لعرض النتيجة" Height="20px" Width="20px" />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="Follow_Date_to"
                        ErrorMessage="أدخل التاريخ ( يوم / شهر/ سنة )" 
                                ValidationExpression="^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2})$|^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2}\s([0-1]\d|[2][0-3])\:[0-5]\d\:[0-5]\d)$"
