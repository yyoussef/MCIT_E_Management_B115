<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Inbox_Minister_Search.aspx.cs" Inherits="WebForms_Inbox_Minister_Search" title="بحث في تأشيرة الوزير"%>
        ...
        <tr>
            <td align="center" class="Text" colspan="3">
                <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText=" رقم القيد " ItemStyle-Width="150">
                            <ItemTemplate>
                               <%-- <%# Eval("Code")%>/<%# Eval("Date")%>--%>
                               <%# Eval("incombination")%>
                            </ItemTemplate>
