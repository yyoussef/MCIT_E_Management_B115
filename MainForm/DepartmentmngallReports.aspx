            ...
            <td valign="top" align="right">
                <table id="second_table_reports" cellpadding="0" cellspacing="0" style="height: 16px;
                    ...
                    <tr id="secondreports" bgcolor="#E6F3FF">
                        ...
                        &nbsp;&nbsp;
                        <td style="font-size: large; color: #0C6AC8; text-decoration: underline blink; font-weight: bold;"
                            bgcolor="#E6F3FF" onmouseover="this.style.cursor='hand'" onclick="ChangeMeCase('div1','Img1');"
                            colspan="2">
                            الخطط الزمنية
                        </td>
                    </tr>
                ...
                <div id="div3" style="display: none; width: 355px;" dir="rtl">
                    <table style="line-height: 2; width: 114%">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="height: 30px">
                                <asp:Image ID="Image11" runat="server" ImageUrl="~/new_images/a1.gif" />
            ...
            <td id="third_td_reports" valign="top" align="right">
                <table id="third_table_reports" cellpadding="0" cellspacing="0" style="height: 43px;
                    ...
                    <tr id="thirdreport" bgcolor="#E6F3FF">
                        ...
                        <td style="font-size: large; color: #0C6AC8; text-decoration: underline blink; font-weight: bold;"
                            bgcolor="#E6F3FF" onmouseover="this.style.cursor='hand'" onclick="ChangeMeCase('div2','Img2');"
                            colspan="2">
                            تقارير عامة
                        </td>
                    </tr>
