<%@ Page Language="VB" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="false"
    CodeFile="Projects.aspx.vb" Inherits="MainForm_Projects" Title="تسجبل مشاريع جديدة" %>
            ...
            <table style="line-height: 2; width: 100%;">
                                    ...
                                    <table id="tblnew" runat="server" visible="false" dir="rtl" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2" dir="rtl">
                                                <table width="100%" cellpadding="0" cellspacing="0" style="height: 14px" class="border">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div id="div0" style="display: block">
                                                                <table id="Table1" runat="server" dir="rtl" style="height: 857px; width: 100%">
                                                                    <tr>
                                                                        <td align="right" dir="rtl" style="width: 199px">
                                                                            <asp:Label ID="lblClassName" runat="server" CssClass="Label" Text="اسم مقترح المشـــــروع : " />
                                                                        </td>
                                                                        <td align="right">
                                                                    ...
                                                                    <tr>
                                                                        <td align="right" dir="rtl" style="width: 199px">
                                                                            <asp:Label ID="label2" runat="server" CssClass="Label" Text="المدير المقتــرح للمشــروع :" />
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" colspan="1">
                                                                            ...
                                                                            <asp:TextBox ID="txtStartDate" runat="server" CssClass="Text" Width="155px" Height="25px" />
                                ...
                                ValidationExpression="^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2})$|^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2}\s([0-1]\d|[2][0-3])\:[0-5]\d\:[0-5]\d)$"
                                    ValidationGroup="A" ErrorMessage=" برجاء إدخال صيغة التاريخ بطريقة صحيحة " Text="*"  > </asp:RegularExpressionValidator>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" dir="rtl" colspan="1">
                                                                            <asp:DropDownList ID="DDLPriority" runat="server" CssClass="Button" Width="199px"
                                                                                Height="25px" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right" dir="rtl" style="width: 199px; height: 50px;">
                                                                            <asp:Label ID="label6" runat="server" CssClass="Label" Text="نوع مقترح المشروع :" />
                                                                        </td>
                                                                        <td align="right" dir="rtl" colspan="1" style="height: 50px">
                                                                            <asp:DropDownList ID="DDLSuggestType" runat="server" CssClass="Button" Width="223px"
                                                                                Height="25px" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" dir="rtl" colspan="1">
                                                                            <div style="overflow: scroll; background-color: #F9fdff; color: #000000;" dir="rtl"
                                                                                class="borderControl">
                                                                                <asp:CheckBoxList ID="CheckCategory" runat="server" DataSourceID="SqlCategory" DataTextField="proj_category"
                                                                                    DataValueField="id" RepeatColumns="4" CssClass="Label" Font-Size="Small">
                                                                                </asp:CheckBoxList>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" dir="rtl" colspan="1">
                                                                            <div style="overflow: scroll; background-color: #F9fdff; color: #000000;" dir="rtl"
                                                                                class="borderControl">
                                                                                <asp:CheckBoxList ID="CheckTechnique" CellPadding="5" CellSpacing="5" RepeatColumns="4"
                                                                                    CssClass="Label" Font-Size="Small" DataTextField="technique" DataValueField="id"
                                                                                    runat="server" DataSourceID="SqlTechnique">
                                                                                </asp:CheckBoxList>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <asp:Button ID="btnAnother" runat="server" CssClass="Button" Text="إدخال مقترح آخر"
                                        ...
                                        <tr>
                                            <td colspan="2" dir="rtl">
                                                <table id="tblfinance" runat="server" width="100%" dir="rtl" class="border">
                                                    <tr>
                                                        <td valign="top" align="right" colspan="2">
                                                            <table width="100%" cellpadding="0" cellspacing="0" style="height: 14px">
                                                                <tr bgcolor="#E6F3FF">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="width: 264px">
                                                                            <asp:DropDownList ID="Quarter" runat="server" CssClass="Button" DataSourceID="SqlDataSource1"
                                                                                DataTextField="Quarter_Name" DataValueField="Quarter_NO" Width="240px" AutoPostBack="True"
                                                                                Enabled="False">
                                                                            </asp:DropDownList>
                                                                        </td>
                                        ...
                                        <tr>
                                            <td colspan="2" dir="rtl">
                                                <table id="tbldoc1" runat="server" width="100%" dir="rtl" class="border">
                                                    <tr>
                                                        <td valign="top" align="right" colspan="2">
                                                            <table width="100%" cellpadding="0" cellspacing="0" style="height: 14px">
                                                                <tr bgcolor="#E6F3FF">
                                                                    ...
                                                                    <td style="font-size: large; color: #0C6AC8; text-decoration: underline blink; font-weight: bold;"
                                                                        onmouseover="this.style.cursor='hand'" onclick="ChangeMeCase('div2','image2');"
                                                                        colspan="2">
                                                                        وثائق المشروع
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div id="div2" style="display: none">
                                                                <table id="tbldoc" width="100%" dir="rtl">
                                                                    <tr>
                                                                        <td align="right" dir="rtl" style="width: 123px">
                                                                            <asp:Label ID="label12" runat="server" CssClass="Label" Text="ملف المشروع:" />
                                                                        </td>
                                                                        <td align="right" dir="rtl" width="700px">
                                                                            <asp:FileUpload ID="DocUpload" runat="server" CssClass="Button" Width="99%" onchange="Get_Value()" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right" dir="rtl" style="width: 123px">
                                                                        ...
                                                                        <td align="center" dir="rtl" width="700px">
                                                                            <asp:TextBox ID="txtDocName" runat="server" CssClass="Text" Width="99%" Height="30px"></asp:TextBox>
                                                                            <br />
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDocName"
                                                                                Display="Dynamic" ErrorMessage="لابد من إدخال وثيقة" Font-Bold="True" Font-Size="12pt"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" dir="rtl" style="text-align: center" class="Text" colspan="2">
                                                                            <asp:GridView ID="GView" runat="server" CssClass="mGrid" AutoGenerateColumns="False"
                                                                                oreColor="Black" BorderColor="#3366CC" BorderStyle="None" Width="100%" AllowSorting="True"
                                                                                Visible="False" EmptyDataText="">
                                                                                <Columns>
                                                                                    <%--<asp:BoundField DataField="PDOC_FileName" HeaderText="اسم الوثيقة" />--%>
                                                                                    <asp:TemplateField HeaderText="وثيقة المشروع" ItemStyle-Width="90%">
                                                                                        <ItemTemplate>
                                                                                        <input id="PDOC_id" runat="server" type="hidden" value='<%# Eval("File_ID") %>'/>
                                                                                            <a href='<%# "Peoject_Document_Details.aspx?File_ID=" & Eval("File_ID") %>'>
                                                                                                <%#Eval("File_name")%></a>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="تعديل" ItemStyle-Width="5%">
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="حذف" ItemStyle-Width="5%">
                                                                                        <ItemTemplate>
                                                                                            <asp:ImageButton ID="ImgBtnDelete" runat="server" ImageUrl="../Images/delete.gif"
                                                                                                OnClick="Doc_ImgBtnDelete_Click" OnClientClick="if (confirm('هل تود الحذف نهائياً') == false) return false;"
                                                                                                CommandArgument='<%# Eval("File_ID") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                            ...
                            <asp:LinkButton ID="Linkview" runat="server" PostBackUrl='<%# "~/WebForms2/Peoject_Document_Details.aspx?PDOC_id=" & Eval("PDOC_id") %>'>عرض الوثيقة</asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="حذف">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                <table id="TableGoals" runat="server" border="0" width="100%" dir="rtl" class="border">
                                                    <tr>
                                                        <td valign="top" align="right" colspan="2">
                                                            <table width="100%" cellpadding="0" cellspacing="0" style="height: 14px">
                                                                <tr bgcolor="#E6F3FF">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div id="div3" style="display: none">
                                                                <table id="Table3" width="100%" dir="rtl">
                                                                    <tr>
                                                                        <td align="center" dir="rtl" style="width: 9%">
                                                                            <asp:Label ID="label8" runat="server" Text="الهـــــــــدف : " Font-Bold="True" Font-Size="15px"
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" align="center" class="style14" style="height: 35px">
                                                                            <asp:Button ID="BtnSaveGoal" runat="server"  CssClass="Button" Text="حفظ الهدف" />
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDocName"
                                                                                Display="Dynamic" ErrorMessage="لابد من إدخال هدف" Font-Bold="True" Font-Size="12pt"
                                                                                ValidationGroup="a"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" colspan="2" dir="rtl">
                                                                            <asp:GridView ID="GridGoals" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                                Width="100%" BackColor="White" ForeColor="Black" BorderColor="#3366CC" BorderStyle="None"
                                                                                BorderWidth="1px" EmptyDataText="... عفوا لا يوجد بيانات ..." CssClass="mGrid"
                                                                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField HeaderText="الهــــــــــدف" DataField="pobj_desc" HeaderStyle-Font-Size="16px"
                                                                                        ...
                                                                                        ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="500px" ItemStyle-Wrap="true" />
                                                                                    <asp:TemplateField HeaderText="تعديل" HeaderStyle-Font-Size="16px" HeaderStyle-Font-Bold="true"
                                                                                        HeaderStyle-Width="25px">
                                                                                        <ItemTemplate>
                                                                                            <input id="PObj_ID_For_Grid" runat="server" type="hidden" value='<%# Eval("PObj_ID") %>' />
                                                                                            <asp:ImageButton ID="ImgBtnGoalEdit" runat="server" ImageUrl="../Images/Edit.jpg"
                                                                                                OnClick="ImgBtnGoalEdit_Click" CommandArgument='<%# Eval("PObj_ID") %>' />
                                                                                        </ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="حذف" ItemStyle-Width="25px" ItemStyle-HorizontalAlign="Center"
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <asp:ImageButton ID="ImgBtnGoalDelete" runat="server" ImageUrl="../Images/delete.gif"
                                                                                                OnClick="ImgBtnGoalDelete_Click" Style="height: 22px" CommandArgument='<%# Eval("PObj_ID") %>'
                                    ...
                                    <ItemTemplate >
                                      ...
                                      <asp:LinkButton ID="Linkview" runat="server"  Text='<%# Eval("PDOC_FileName") %>' PostBackUrl='<%# "~/WebForms2/Peoject_Document_Details.aspx?PDOC_id=" & Eval("PDOC_id") %>'> </asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Button ID="BtnSend" runat="server" CssClass="Button" Text="إرسال إلي الإدارة العليا"
                                                    Width="170px" />
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td>
                        ...
                        <input id="FileDoc_id" runat="server" type="hidden" />
                        <input id="PDOC_id" runat="server" type="hidden" />
