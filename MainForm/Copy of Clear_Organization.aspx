<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true" CodeFile="Copy of Clear_Organization.aspx.cs" Inherits="WebForms_Clear_Organization_Old" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div>
        <table width="90%">
            <tr>
                <td>
                    <asp:Label ID="Label12" CssClass="Label"  runat="server" Text="الاسم" />
                </td>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px"
                        dir="rtl" align="right">
                        <asp:CheckBoxList ID="chklst_Org" CellPadding="5" CellSpacing="5" RepeatColumns="1"
            ...
            <tr>
             ...
             <tr>
                <td colspan="2">
                    <asp:Button ID="Button1" runat="server" Text="حفظ"  CssClass="Button" OnClick="btn_Save_Click" />
                </td>
            </tr>
