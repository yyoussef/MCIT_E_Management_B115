<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Inbox_Minister_Search_without_edit.aspx.cs" Inherits="WebForms_Inbox_Minister_Search_without_edit" %>
    ...
    <table dir="rtl" style="line-height: 2; width: 99%;">
        ...
        <tr>
            <td align="right" dir="rtl" style="width: 142px">
                <asp:Label ID="Label3" runat="server" CssClass="Label" Text="جهة التأشيرة : "></asp:Label>
            </td>
        ...
        <tr>
            <td align="right" dir="rtl" style="width: 142px; height: 35px;">
                <asp:Label ID="Label5" runat="server" CssClass="Label" Text="تاريخ التأشيرة:" />
            </td>
            <td style="width: 10px;">
                ...
                <div align="center">
                    <asp:Button ID="SaveButton" Text="بحث" OnClick="SaveButton_Click" runat="server"
                        ...
                        &nbsb&nbsb&nbsb&nbsb&nbsb
                         <asp:Button ID="btn_Report" Text="تقرير متابعة تأشيرة الوزير"  runat="server"
                        CssClass="Button" onclick="btn_Report_Click" Width="200px" />
        ...
        <tr>
            <td align="center" class="Text" colspan="3">
                <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText=" كود التأشيرة " ItemStyle-Width="150">
                            <ItemTemplate>
                               <%# Eval("Code")%>
                                <%--<%# Eval("incombination")%>--%>
                            </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="تاريخ التأشيرة" ItemStyle-Width="100">
                            <ItemTemplate>
                                <%# Eval("Date")%>
                            </ItemTemplate>
...
<ItemStyle Width="100px"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="جهة التأشيرة">
                            <ItemTemplate>
                                <%# Eval("Org_Desc")%>
                            </ItemTemplate>
                        </asp:TemplateField>
