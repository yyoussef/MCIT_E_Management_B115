<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Connecting_InIR_OutIR.aspx.cs" Inherits="WebForms_Connecting_InIR_OutIR" Title="المرتبط" %>
    ...
    <table dir="rtl" style="line-height: 2; width: 99%;">
            ...
            <td align="center" colspan="3" style="height: 33px">
                ...
                <div id="div_choose" style="display: block" runat="server">
                    <asp:DropDownList ID="Drop_choose" runat="server" AutoPostBack="true" CssClass="drop"
                        ...
                        <asp:ListItem Text="تأشيرة وزير" Value="3"></asp:ListItem>
                       <%-- <asp:ListItem Text="الكل" Value="4"></asp:ListItem>--%>
                    </asp:DropDownList>
                </div>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="height: 33px">
                ...
                <div id="div_title_inbox_minister" style="display: none" runat="server">
                    <asp:Label ID="Label8" runat="server" CssClass="PageTitle" Text="تأشيرة وزير" />
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" class="Text" colspan="3">
                <div id="div_grid_Main" style="display: block" runat="server">
                    <asp:GridView ID="gvMain" OnRowDataBound="gvMain_RowDataBound" runat="server" AutoGenerateColumns="False"
                        ...
                        AlternatingRowStyle-CssClass="alt" OnRowCommand="gvMain_RowCommand" 
...
<ItemStyle Width="100px"></ItemStyle>
                           ...
                           <%-- <asp:TemplateField HeaderText="المرتبط">
                                <ItemTemplate>
                                    <asp:LinkButton ID="link_minister" runat="server" CommandArgument='<%# Eval("ID") %>'
                                        CommandName="Link_minister">المرتبط</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                        </Columns>
