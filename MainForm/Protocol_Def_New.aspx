<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Protocol_Def_New.aspx.cs" Inherits="WebForms_Protocol_Def_New" Title="بروتوكولات / اتفاقيات" %>
            ...
            <td dir="rtl" align="center" style="height: 61px">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="right" dir="rtl">
                            <asp:Label ID="Label2" runat="server" CssClass="Label" Text=" نوع المشاركة : " />
                        </td>
                        <td align="right" dir="rtl">
                            <asp:DropDownList ID="ddl_Type_coop" runat="server" CssClass="drop" Width="220px">
                                <asp:ListItem Text="اختر نوع المشاركة" Value="0"></asp:ListItem>
                                <asp:ListItem Text="مشاركة فنية" Value="1"></asp:ListItem>
                                <asp:ListItem Text="مشاركة مالية" Value="2"></asp:ListItem>
                                <asp:ListItem Text="مشاركة تدريبية" Value="3"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:TextBox ID="txtamount" runat="server" CssClass="Text">
                            </asp:TextBox>
                            <asp:Label ID="lbl" CssClass="Label" runat="server" Text="ج.م" >
                            </asp:Label>
                        </td>
                    </tr>
                    <tr>
                    <td align="right" dir="rtl">
                            <asp:Label ID="Label11" runat="server" CssClass="Label" Text=" المسئول عن البروتوكول : " />
                        </td>
                        <td align="right" dir="rtl">
                            <asp:DropDownList ID="ddl_PMP_ID" runat="server"  CssClass="drop">
                            </asp:DropDownList>
                        ...
                        <td align="right" dir="rtl">
                            ...
                            <asp:ImageButton ID="ImageButton2" runat="Server" AlternateText="اضغط لعرض النتيجة"
                                Height="23px" ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtsigndate"
                        ...
                        <td align="right" dir="rtl">
                            ...
                            <asp:ImageButton ID="Image1" runat="Server" AlternateText="اضغط لعرض النتيجة" Height="23px"
                                ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                  <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txt_Signt_Str_DT"
                        ...
                        <td align="right" dir="rtl">
                            ...
                            <asp:ImageButton ID="ImageButton1" runat="Server" AlternateText="اضغط لعرض النتيجة"
                                Height="23px" ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                   ...
                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txt_Signt_End_DT"
                    ...
                    <tr>
                        <td align="right" dir="rtl">
                            <asp:Label ID="Label30" runat="server" CssClass="Label" Text=" المدة : " />
                        </td>
                        <td align="right" dir="rtl">
                            <asp:TextBox ID="txtperiod" Height="26px" CssClass="Text" runat="server"></asp:TextBox>
                            <asp:Label ID="lblperiod" runat="server" CssClass="Label" Text="يوم" ></asp:Label>
                        </td>
                        
                    </tr>
                    <tr>
                        <td align="right" dir="rtl">
                            <asp:Label ID="Label6" runat="server" CssClass="Label" Text="الموازنة الكلية بالعملة المحلية  : " />
                        </td>
                        <td align="right" dir="rtl">
                        ...
                        <td align="right" dir="rtl">
                            <asp:Label ID="Label8" runat="server" CssClass="Label" Text=" بالعملة الاجنبية : " />
                        </td>
                        <td align="right" dir="rtl">
                            ...
                            <td align="right" dir="rtl">
                                ...
                                <asp:ImageButton ID="ImageButton4" runat="Server" AlternateText="اضغط لعرض النتيجة"
                                    Height="23px" ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                       ...
                                       <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtFrom"
                            ...
                            <td align="right" dir="rtl">
                                ...
                                <asp:ImageButton ID="ImageButton5" runat="Server" AlternateText="اضغط لعرض النتيجة"
                                    Height="23px" ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                                           ...
                                                           <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtTo"
                                        ...
                                        <asp:TemplateField HeaderText="حذف" ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgBtnDelete" CommandName="RemoveItem" runat="server" ImageUrl="../Images/delete.gif"
                                                    Style="height: 22px" CommandArgument='<%# Eval("Protocol_Balance_ID") %>' />
                                            </ItemTemplate>
            ...
            <td>
                <div id="div2" style="display: block" dir="rtl">
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:Label ID="Label10" runat="server" CssClass="Label" Text=" الاسم : " />
                                <input type="hidden" runat="server" id="hidden3" />
                            </td>
                            <td align="right" dir="rtl">
                                <asp:TextBox ID="txtproj" runat="server" Height="26px" CssClass="Text"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                            <asp:Button ID="saveproj" runat="server" CssClass="Button" Text="حفظ" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="div1" style="display: block" dir="rtl">
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddl_Parent_ID" runat="server" Style="font-size: small;" CssClass="drop">
                                </asp:DropDownList>
                            </td>
                            <td rowspan="6" valign="top">
                                <div style="overflow: scroll; background-color: #F9fdff; color: #000000; height: 289px"
                                    dir="rtl" align="right">
                                    <asp:TreeView ID="Tree_Files" ExpandDepth="1" runat="server" ImageSet="Simple" Font-Bold="True"
                                        ForeColor="Black" ShowCheckBoxes="None" Height="187px">
                            ...
                            <td>
                                ...
                                <asp:ImageButton ID="ImageButton6" runat="Server" AlternateText="اضغط لعرض النتيجة"
                                    Height="23px" ImageUrl="~/images/Calendar_scheduleHS.png" Width="23px" ToolTip="تقويم" />
                                      ...
                                      <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txt_File_Date"
                                ValidationExpression="^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2})$|^(([0-2]\d|[3][0-1])\/([0]\d|[1][0-2])\/[2][0]\d{2}\s([0-1]\d|[2][0-3])\:[0-5]\d\:[0-5]\d)$"
                ...
                <asp:GridView ID="grd_View_Mng" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="حذف" ItemStyle-Width="20px">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgBtnDelete" CommandName="RemoveItem" runat="server" ImageUrl="../Images/delete.gif"
                                    Style="height: 22px" CommandArgument='<%# Eval("Protocol_ID") %>' />
                            </ItemTemplate>
                            <ItemStyle Width="20px"></ItemStyle>
                        </asp:TemplateField>
                    </Columns>
