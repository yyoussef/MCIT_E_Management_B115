<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true"
    CodeFile="Project_Scope_Assumptions_Dlev.aspx.cs" Inherits="WebForms_Project_Scope_Assumptions_Dlev"   %> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table dir="rtl" style="line-height: 2; width: 99%;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" CssClass="Text" ID="name" Width="700px" TextMode="MultiLine" Height="100px"></asp:TextBox>
            </td>
        </tr>
        <tr>
