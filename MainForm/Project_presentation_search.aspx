<%@ Page Language="C#" MasterPageFile="~/Masters/MainformMaster.Master" AutoEventWireup="true" CodeFile="Project_presentation_search.aspx.cs" Inherits="WebForms_Project_presentation_search" %>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <cc1:CalendarExtender ID="txtdate_CalendarExtender" runat="server" Format="dd/MM/yyyy"
                                PopupButtonID="Image1" TargetControlID="Presentation_date_from">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                PopupButtonID="Image2" TargetControlID="Presentation_date_to">
                            </cc1:CalendarExtender>
                ...
                <tr>
                    <td align="center" class="Text" colspan="3">
                        <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            GridLines="Vertical">
                            <Columns>
                                <asp:TemplateField HeaderText="العرض" HeaderStyle-Width="20%" 
