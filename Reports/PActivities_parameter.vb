...
Public Class PActivities_parameter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PActivities_parameter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPActivities_parameter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PActivities_parameter = New PActivities_parameter
        rpt.Site = Me.Site
        Return rpt
    End Function
