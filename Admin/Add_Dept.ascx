<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Add_Dept.ascx.cs" Inherits="UserControls_Add_Dept" %>
...
<table dir="rtl" style="line-height: 2; width: 99%;">
    <tr>
        <td colspan="2" align="center" style="height: 82px">
            <asp:Label ID="lbl1" runat="server" Text="بيانات الادارات" Font-Size="17pt" ForeColor="Black"></asp:Label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="width: 80px; height: 71px;">
            <asp:Label ID="Label1" runat="server" Text="اسم القطاع" CssClass="Label"></asp:Label>
        </td>
        <td>
        ...
        <td colspan="2" align="center">
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="اسم التصنيف" DataField="Dept_name" ControlStyle-Font-Size="X-Large" />
