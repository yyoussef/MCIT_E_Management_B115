<%@ Page Language="C#" MasterPageFile="~/Masters/SuperAdminMaster.master" AutoEventWireup="true"
    CodeFile="pages.aspx.cs" Inherits="suber_admin_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Text="اسم الصفحه " ForeColor="Black" Font-Bold="True"
        ...
        <tr> 
            <td colspan="2">
                ...
                <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand " runat="server"
                    ...
                    onpageindexchanging="GridView1_PageIndexChanging" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" PageIndex="10">
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="3px" HeaderText="م"
                        ...
                        <asp:BoundField DataField="Name" HeaderText="اسم العنصر الرئيسى" ControlStyle-Font-Size="X-Large"/>
