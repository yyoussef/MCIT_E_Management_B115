<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Change_Password_new.ascx.cs"
    ...
    <tr align="center">
        ...
        <td align="right">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtNewPassword"
                ...
                ValidationGroup="change" ErrorMessage="كلمة السر القوية تتكون من 8 حروف. برجاء عدم استخدام الأسماء او الكلمات.استخدم خليط من الحروف و الأرقام و العلامات "></asp:RegularExpressionValidator>
